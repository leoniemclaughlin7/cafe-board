...
def send_email(request):
    ...
    Assistance with django emails:
    https://opensource.com/article/22/12/django-send-emails-smtp
    A Success message is displayed once email is sent successfully.
    Help with EmailMessage class:
    https://stackoverflow.com/questions/59802624/contact-form-sending-emails-from-and-to-the-same-email-django
    """
        ...
        with get_connection(
           ...
           use_tls=settings.EMAIL_USE_TLS
            ...
            EmailMessage(subject=name, body=message, from_email=from_email,
                         to=recipient_list, reply_to=[from_email],
                         connection=connection).send()
        messages.add_message(request, messages.SUCCESS,
                             'Your email was sent expect a reply in 24hrs.')
